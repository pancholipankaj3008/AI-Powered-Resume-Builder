...
const PersonalInfo = ({
    ...
    const Field = ({ name, label, type = "text", placeholder, required, span, icon: Icon }) => (
            ...
            <div className="relative z-10">
                ...
                <div className="mb-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <Field name="firstName" label="First Name" placeholder="John" required icon={User} />
                        <Field name="lastName" label="Last Name" placeholder="Doe" required icon={User} />
                    </div>
                </div>
                ...
                <div className="mb-8 pt-6 border-t border-white/5">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <Field name="email" label="Email" type="email" placeholder="name@domain.com" required icon={Mail} />
                        <Field name="phone" label="Phone Number" type="tel" placeholder="+91 98765 43210" icon={Phone} />
                        <Field name="address" label="Address" placeholder="Street, Area" span icon={MapPin} />
                        <Field name="city" label="City" placeholder="Mumbai" icon={MapPin} />
                        <Field name="state" label="State" placeholder="Maharashtra" icon={MapPin} />
                        <Field name="country" label="Country" placeholder="India" icon={MapPin} />
                    </div>
                </div>
                ...
                <div className="pt-6 border-t border-white/5">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <Field name="linkedin" label="LinkedIn Profile" type="url" placeholder="linkedin.com/in/johndoe" icon={Briefcase} />
                        <Field name="github" label="GitHub Profile" type="url" placeholder="github.com/johndoe" icon={Code2} />
                        <Field name="portfolio" label="Portfolio" type="url" placeholder="yourportfolio.com" icon={Link2} />
                        <Field name="website" label="Personal Website" type="url" placeholder="yourwebsite.com" icon={Globe} />
                    </div>
                </div>
            </div>
        </div>
