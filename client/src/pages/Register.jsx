    ...
    return (
        <div className="min-h-screen bg-[#07080a] text-[#e4e6eb] font-sans flex items-center justify-center overflow-hidden relative selection:bg-[#fbbf24] selection:text-[#0b0c0e] px-4">
            ...
            <style>{`
                ...
                .aurora-layer {
                    animation: aurora-spin 40s linear infinite, aurora-hue 18s linear infinite;
                }
            ...
            <div className="fixed inset-0 pointer-events-none overflow-hidden z-0 flex items-center justify-center">
                <div
                    ...
                    style={{
                        background: "conic-gradient(from 0deg, #fde68a, #fbbf24, #d97706, #f59e0b, #fde68a)"
                    }}
                ></div>
            </div>
            ...
            <div className="fixed inset-0 pointer-events-none overflow-hidden z-0">
                <div className="blob-1 absolute -top-40 -right-40 w-[36rem] h-[36rem] bg-[#fbbf24] rounded-full opacity-[0.08] blur-[140px]"></div>
                <div className="blob-2 absolute -bottom-40 -left-40 w-[32rem] h-[32rem] bg-[#d97706] rounded-full opacity-[0.09] blur-[150px]"></div>
            ...
            <div className="w-full max-w-md relative z-10">
                ...
                >
                    ...
                    <h2 className="text-xl sm:text-2xl font-black tracking-tight text-white text-center mb-1 relative z-10">Create Workspace Account</h2>
                    <p className="text-xs text-gray-500 text-center mb-6 font-medium relative z-10">Join us to start building dynamic ATS optimized configurations</p>
                    ...
                    <div className="space-y-4 relative z-10">
                        <div>
                            <label className="block text-[11px] font-bold tracking-widest text-gray-400 uppercase mb-2 px-1">Full Name</label>
                        ...
                        <div>
                            <label className="block text-[11px] font-bold tracking-widest text-gray-400 uppercase mb-2 px-1">Create Security Password</label>
                            <div className="relative">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4 text-[#fbbf24]/60 absolute left-4 top-1/2 -translate-y-1/2">
                    ...
                    >
                        <span className="relative z-10">{loading ? "Generating Safe Token..." : "Register Global Profile"}</span>
                    </button>

                    <p className="mt-6 text-xs text-center text-gray-400 font-medium relative z-10">
                        Already have an active account?{" "}
                        <Link to="/login" className="text-[#fbbf24] hover:underline font-bold">Login</Link>
                    </p>
                </form>
            </div>
        </div>
